...
public class Helpers {
    ...
    static public boolean doesFileExist(Context c, String fileName, long fileSize,
        ...
        Log.d("cocos2d-x",">>>>>>>>>>>>>>>>>>>");
        Log.d("cocos2d-x",fileName);
        Log.d("cocos2d-x",Helpers.generateSaveFileName(c, fileName));
        Log.d("cocos2d-x",Long.toString(fileSize));
        Log.d("cocos2d-x",Boolean.toString(fileForNewFile.exists()));
        if (fileForNewFile.exists()) {
            
            Log.d("cocos2d-x",Long.toString(fileForNewFile.length()));
            Log.d("cocos2d-x",Long.toString(fileSize));
